  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="mb-6 flex items-center justify-between">
        ...
        <select className="rounded-md border border-slate-300 bg-slate-50 px-3 py-1.5 text-sm text-slate-700 outline-none">
      ...
      <div className="flex h-64 items-end justify-between gap-2">
        {data.map((item) => (
          <div key={item.day} className="group relative flex w-full flex-col items-center justify-end">
            <div className="absolute -top-10 hidden rounded bg-slate-800 px-2 py-1 text-xs text-white group-hover:block">
