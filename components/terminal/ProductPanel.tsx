      ...
      <div className="px-6 pt-6 pb-2">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            <div className="absolute left-3 top-2.5 flex items-center text-blue-600">
          ...
          <button className="rounded-md bg-slate-800 px-5 py-2.5 text-sm font-bold text-white hover:bg-slate-900">
            ALL
          </button>
        </div>
      </div>
